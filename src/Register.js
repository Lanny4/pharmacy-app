  ...
  return (
    <Container className="py-5 d-flex justify-content-center">
      <Card className="p-4 shadow border-0" style={{ maxWidth: '450px', width: '100%', borderRadius: '20px' }}>
        <h2 className="text-center fw-bold mb-4" style={{color: 'var(--deep-green)'}}>Створити профіль</h2>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="password" className="rounded-pill px-4" onChange={(e) => setPassword(e.target.value)} required />
          </Form.Group>
          <Form.Group className="mb-4">
            <Form.Label>Підтвердіть пароль</Form.Label>
            <Form.Control type="password" className="rounded-pill px-4" onChange={(e) => setConfirmPassword(e.target.value)} required />
          </Form.Group>
          <Button variant="success" className="w-100 py-2 mb-3 shadow-sm" type="submit">
            Зареєструватися
          </Button>
